...
const Category = ({ category }) => {
    ...
    return (
        <div>
            <div className="shadow-lg bg-gray-50 text-gray-800 my-5 transform hover:scale-110 duration-500">
                <img src={photoUrl} alt="" className="object-cover object-center transform hover:scale-150 duration-500 lg:mx-auto lg:w-[200px] rounded-t-md h-[180px] bg-gray-500" />
