        ...
        <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-pink-800 text-gray-100 container mx-auto my-8">
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col items-center py-6 space-y-3">
                    <span className="text-center">How was your experience from KIDDY TEDDY ?</span>
                ...
                <div className="flex flex-col w-full">
                    ...
                    <button type="button" className="py-4 my-8 font-semibold rounded-md text-gray-900 bg-pink-400">Leave feedback</button>
                </div>
            </div>
