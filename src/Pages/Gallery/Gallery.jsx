...
const Gallery = () => {
    ...
    return (
        <section className=" py-6 b mt-8 container mx-auto">

            <div className='font-bold text-4xl text-center m-3 text-cyan-500'>
                <h1>Toys Gallery</h1>
            </div>

            <div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4 border-gray-400 shadow-lg">
                ...
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square border-gray-100" src={G2} />
