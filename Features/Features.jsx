            ...
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                ...
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="mt-12 space-y-12">
                            <div className="flex">
                                <div className="flex-shrink-0">
                                    <div className="flex items-center justify-center w-12 h-12 rounded-md bg-cyan-600 text-gray-50">
                    ...
                    <div aria-hidden="true" className="mt-10 lg:mt-0">
                        <img src="https://img.freepik.com/free-photo/boy-dinosaur-costume-playing_23-2148551169.jpg" alt="" className="mx-auto rounded-lg shadow-lg bg-gray-500" />
                    </div>
                </div>
                <div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                            <img src="https://img.freepik.com/free-photo/handshake-business-men-concept_53876-31214.jpg?w=740&t=st=1691860874~exp=1691861474~hmac=c65314de482a074c4c7a1f71ec867b3d98b1df4ad42c4c5c0351f550efd18a7e" alt="" className="mx-auto rounded-lg shadow-lg bg-gray-500" />
                        </div>
                    </div>
                </div>
            </div>
